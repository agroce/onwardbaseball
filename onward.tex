...
common; we oughta do something about that.
  \end{abstract}
...
prominent characters in Chapter 4 of Alan Schwarz's book, \emph{The
  Numbers Game: Baseball's Lifelong Fascination with Statistics}~\cite{schwarz2004number}.
...
and government mainframes. The deeper connection, however, essay addresses, is that baseball
...
widely-used numbers, lacking in proven operational relevance, should
sound familliar to students of software engineering.
...
invented Mr. Ed) \emph{Freddy and the Baseball Team from Mars}, by the way).},
...
and Willy Mays played at the same time or not), alas, probably is
still more familliar with code coverage than mutation score, but the
