...
Harlon and Eldon were among many high-powered
...
Comparing baseball and software engineering would require considerable argument
and evidence. They have the following similarities:
...
software testing.\footnote{We could also compare LOC produced to modern
...
\begin{itemize}
  \item Baseball and software engineering are both, when played for
    ...
    \item The ``game''  is deeply structured and appeals to
      ...
      \item Arguably, for some historical, contingent reason, Americans are best
        ...
        [ I'd drop this item altogether. Cute but triggering. -- kosak ]
 ...
 who are trying to replace a certain critical individual player. Bean
